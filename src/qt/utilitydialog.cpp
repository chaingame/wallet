...
All the CG in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CG, 0.1 CG, 1 CG and 10 CG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://https://github.com/Anonymousblockchain\">https://github.com/Anonymousblockchain</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
