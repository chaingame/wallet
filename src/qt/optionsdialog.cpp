    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CG-light"), QVariant("light"));
    ui->theme->addItem(QString("CG-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CG-traditional"), QVariant("trad"));
