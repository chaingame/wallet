...
const char * const BITCOIN_CONF_FILENAME = "ChainGame.conf";
const char * const BITCOIN_PID_FILENAME = "ChainGamed.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ChainGameCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ChainGameCore
    // Mac: ~/Library/Application Support/ChainGameCore
    // Unix: ~/.pptpcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ChainGameCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ChainGameCore";
#else
    // Unix
    return pathRet / ".ChainGameCore";
#endif
#endif
}
