...
HEADERS += \
        ...
        src/crypto/yescrypt/sha256.h \
        src/crypto/yescrypt/sha256_c.h \
        src/crypto/yescrypt/sysendian.h \
        src/crypto/yescrypt/yescrypt-best_c.h \
        src/crypto/yescrypt/yescrypt-opt_c.h \
        src/crypto/yescrypt/yescrypt-platform_c.h \
        src/crypto/yescrypt/yescrypt-simd_c.h \
...
SOURCES += \
        ...
        src/versionbits.cpp \
        src/bench/bench.cpp \
        src/bench/bench_pptp.cpp \
        src/bench/bench_wabi.cpp \
        ...
        src/crypto/simd.c \
        src/crypto/skein.c \
        src/crypto/yescrypt/yescrypt.c \
...
RESOURCES += \
        src/qt/pptp.qrc \
        src/qt/pptp_locale.qrc
TRANSLATIONS += \
        src/qt/locale/pptp_bg.ts \
        src/qt/locale/pptp_de.ts \
        src/qt/locale/pptp_en.ts \
        src/qt/locale/pptp_es.ts \
        src/qt/locale/pptp_fi.ts \
        src/qt/locale/pptp_fr.ts \
        src/qt/locale/pptp_it.ts \
        src/qt/locale/pptp_ja.ts \
        src/qt/locale/pptp_pl.ts \
        src/qt/locale/pptp_pt.ts \
        src/qt/locale/pptp_ru.ts \
        src/qt/locale/pptp_sk.ts \
        src/qt/locale/pptp_sv.ts \
        src/qt/locale/pptp_vi.ts \
        src/qt/locale/pptp_zh_CN.ts \
        src/qt/locale/pptp_zh_TW.ts
